...
export const coachingDecisions: CoachingDecisionTemplate[] = [
  ...
  {
    trigger: 'ANY',
    prompt: "You're on the penalty kill and they're dominating possession.",
    options: [
      { text: "Collapse into a tighter box", effect: genericEffect },
      { text: "Send out your most aggressive PK forwards", effect: genericEffect },
      { text: "Clear the puck at every opportunity", effect: genericEffect },
    ]
  },
  {
    trigger: 'ANY',
