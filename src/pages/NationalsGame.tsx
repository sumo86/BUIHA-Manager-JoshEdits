...
import { GameState, GameEvent, GameDate, ScheduleEntry, Team } from '@/types';
...
const NationalsGame = () => {
    ...
    const handleGameEnd = () => {
        ...
        processGameResults(userTeam, opponentTeam, gameState, true); // Pass true for isNationalsGame
    };
