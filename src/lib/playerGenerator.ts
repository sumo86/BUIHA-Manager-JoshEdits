...
export const getGamesPlayedForDivision = (leagueDivision: string): number => {
    // Specific divisions first
    if (leagueDivision === 'Non Checking 3 - North') return 6;
    if (leagueDivision === 'Non Checking 3 - South') return 12;
    if (leagueDivision === 'Non Checking 2 - North') return 6;
    if (leagueDivision === 'Non Checking 2 - South') return 12;
    
    // General division types
    ...
    if (leagueDivision.includes('Non Checking 3')) return 6; // Fallback for generic Non Checking 3
